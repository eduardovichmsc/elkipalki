...
const steps = [
	{
		num: "01",
		title: "Елки",
		desc: "Каждая указанная елка пышные и красивые. Прямо как настоящие.",
	},
	{
		num: "02",
		title: "Бережная доставка",
		desc: "Ёлка доставляется в прочной, безопасной упаковке, которая защищает ветки и крепления от повреждений. Мы аккуратно фиксируем все элементы, чтобы ёлка приехала к вам в идеальном состоянии — без заломов, потёртостей и деформаций.",
	},
	{
		num: "03",
